<template>
  <div class="app-container">
    <div class="filter-container" style="padding-top: 0px;">
      <el-input v-model="materialCode" size="mini" placeholder="输入物资代码" style="width: 180px; margin-right:20px; margin-bottom: 0px; " class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="预计入库数量">
        <template slot-scope="{row}">
          <span>{{ row.standards }}</span>
        </template>
      </el-table-column>
